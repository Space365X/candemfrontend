!function(e, t) {
    ...
    function g(e) {
        return e.replace(ze, "ms-").replace(Ve, h)
    }
    function v() {
    ...
    function m(e, t, n) {
        ...
        if (void 0 === n && 1 === e.nodeType)
            if (r = "data-" + t.replace(Ke, "-$&").toLowerCase(),
            n = e.getAttribute(r),
            "string" == typeof n) {
                try {
                    n = y(n)
    ...
    function x(e, t, n, r) {
        ...
        , u = s(), l = n && n[3] || (Se.cssNumber[t] ? "" : "px"), c = e.nodeType && (Se.cssNumber[t] || "px" !== l && +u) && et.exec(Se.css(e, t));
        if (c && c[3] !== l) {
            for (u /= 2,
            l = l || c[3],
            c = +u || 1; a--; )
    ...
    function b(e) {
        var t, n = e.ownerDocument, r = e.nodeName, i = at[r];
    ...
    function w(e, t) {
        for (var n, r, i = [], o = 0, a = e.length; o < a; o++)
            ...
            t ? ("none" === n && (i[o] = Ye.get(r, "display") || null,
            i[o] || (r.style.display = "")),
            "" === r.style.display && ot(r) && (i[o] = b(r))) : "none" !== n && (i[o] = "none",
            Ye.set(r, "display", n)));
        for (o = 0; o < a; o++)
    ...
    function S(e, t, n, i, o) {
        ...
        h = 0; a = d[h++]; )
            ...
            s = T(p.appendChild(a), "script"),
            c && C(s),
            n)
                for (f = 0; a = s[f++]; )
                    lt.test(a.type || "") && n.push(a);
        return p
    }
    function E() {
        return !0
        ...
        void Se.event.add(e, t, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    ...
                    r && (Ye.set(this, t, Se.event.trigger(r[0], r.slice(1), this)),
                    e.stopPropagation(),
    ...
    function O(e, t, r, i) {
        ...
        if (g || p > 1 && "string" == typeof h && !ye.checkClone && ht.test(h))
            return e.each(function(n) {
                var o = e.eq(n);
                g && (t[0] = h.call(this, n, o.html())),
                O(o, t, r, i)
            });
        if (p && (o = S(t, e[0].ownerDocument, !1, e, i),
        a = o.firstChild,
        1 === o.childNodes.length && (o = a),
        a || i)) {
            for (s = Se.map(T(o, "script"), N),
            u = s.length; f < p; f++)
                l = o,
                f !== d && (l = Se.clone(l, !0, !0),
                u && Se.merge(s, T(l, "script"))),
                r.call(e[f], l, f);
            if (u)
                ...
                f = 0; f < u; f++)
                    l = s[f],
                    lt.test(l.type || "") && !Ye.access(l, "globalEval") && Se.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? Se._evalUrl && !l.noModule && Se._evalUrl(l.src, {
    ...
    function P(e, t, n) {
        for (var r, i = t ? Se.filter(t, e) : e, o = 0; null != (r = i[o]); o++)
            ...
            r.parentNode && (n && rt(r) && C(T(r, "script")),
            r.parentNode.removeChild(r));
        return e
    }
    function R(e, t, n) {
        var r, i, o, a, s = yt.test(t), u = e.style;
        return n = n || mt(e),
        n && (a = n.getPropertyValue(t) || n[t],
        s && a && (a = a.replace(De, "$1") || void 0),
        "" !== a || rt(e) || (a = Se.style(e, t)),
        !ye.pixelBoxStyles() && vt.test(a) && bt.test(t) && (r = u.width,
        i = u.minWidth,
        o = u.maxWidth,
    ...
    function $(e, t, n, r, i, o) {
        ...
        for (; a < 4; a += 2)
            ...
            r ? ("content" === n && (u -= Se.css(e, "padding" + tt[a], !0, i)),
            "margin" !== n && (u -= Se.css(e, "border" + tt[a] + "Width", !0, i))) : (u += Se.css(e, "padding" + tt[a], !0, i),
            "padding" !== n ? u += Se.css(e, "border" + tt[a] + "Width", !0, i) : s += Se.css(e, "border" + tt[a] + "Width", !0, i));
    ...
    function B(e, t, n) {
        ...
        return (!ye.boxSizingReliable() && a || !ye.reliableTrDimensions() && o(e, "tr") || "auto" === u || !parseFloat(u) && "inline" === Se.css(e, "display", !1, r)) && e.getClientRects().length && (a = "border-box" === Se.css(e, "boxSizing", !1, r),
        s = l in e,
        s && (u = e[l])),
        u = parseFloat(u) || 0,
    ...
    function X() {
        At && (be.hidden === !1 && e.requestAnimationFrame ? e.requestAnimationFrame(X) : e.setTimeout(X, Se.fx.interval),
        Se.fx.tick())
    }
    function U() {
    ...
    function G(e, t, n) {
        var r, i, o, a, s, u, l, c, f = "width"in t || "height"in t, p = this, d = {}, h = e.style, g = e.nodeType && ot(e), v = Ye.get(e, "fxshow");
        ...
        u || !Se.isEmptyObject(d)) {
            ...
            u = !1;
            for (r in d)
                u || (v ? "hidden"in v && (g = v.hidden) : v = Ye.access(e, "fxshow", {
                    display: l
                }),
                o && (v.hidden = !g),
                g && w([e], !0),
    ...
    function Q(e, t, n) {
        var r, i, o = 0, a = Q.prefilters.length, s = Se.Deferred().always(function() {
            delete u.elem
        }), u = function() {
            if (i)
                return !1;
            for (var t = jt || U(), n = Math.max(0, l.startTime + l.duration - t), r = n / l.duration || 0, o = 1 - r, a = 0, u = l.tweens.length; a < u; a++)
                l.tweens[a].run(o);
        ...
        for (Y(c, l.opts.specialEasing); o < a; o++)
            if (r = Q.prefilters[o].call(l, e, c, l.opts))
                return me(r.stop) && (Se._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)),
                r;
        return Se.map(c, V, l),
    ...
    Se.extend({
        ...
        isPlainObject: function(e) {
            var t, n;
            return !(!e || "[object Object]" !== de.call(e)) && (!(t = se(e)) || (n = he.call(t, "constructor") && t.constructor,
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (i(Object(e)) ? Se.merge(n, "string" == typeof e ? [e] : e) : ce.call(n, e)),
            n
        },
    ...
    !function() {
        ...
        function n(e, t, r, i) {
            var o, a, s, u, l, c, d, v = t && t.ownerDocument, y = t ? t.nodeType : 9;
            if (r = r || [],
            ...
            L)) {
                    ...
                    if (o = l[1]) {
                        if (9 === y) {
                            ...
                            if (s.id === o)
                                return P.call(r, s),
                                r
                        } else if (v && (s = v.getElementById(o)) && n.contains(t, s) && s.id === o)
                            return P.call(r, s),
                            r
                    } else {
                        if (l[2])
                ...
                if (!(B[e + " "] || H && H.test(e))) {
                    if (d = e,
                    v = t,
                    1 === y && (J.test(e) || Q.test(e))) {
                        for (v = ie.test(e) && f(t.parentNode) || t,
                        v == t && ye.scope || ((u = t.getAttribute("id")) ? u = Se.escapeSelector(u) : t.setAttribute("id", u = R)),
                        c = h(e),
                        a = c.length; a--; )
                            c[a] = (u ? "#" + u : ":scope") + " " + g(c[a]);
                        d = c.join(",")
                    ...
                    try {
                        return P.apply(r, v.querySelectorAll(d)),
                        r
                    } catch (m) {
                        B(e, !0)
                    } finally {
        ...
        function p(e) {
            ...
            return r != N && 9 === r.nodeType && r.documentElement ? (N = r,
            q = N.documentElement,
            L = !Se.isXMLDoc(N),
            O = q.matches || q.webkitMatchesSelector || q.msMatchesSelector,
            qe != N && (t = N.defaultView) && t.top !== t && t.addEventListener("unload", le),
            ye.getById = a(function(e) {
                return q.appendChild(e).id = Se.expando,
            ...
            ye.cssHas = a(function() {
                try {
                    return N.querySelector(":has(*,:jqfake)"),
                    !1
                } catch (e) {
                    return !0
                }
            ...
            a(function(e) {
                var t;
                q.appendChild(e).innerHTML = "<a id='" + R + "' href='' disabled='disabled'></a><select id='" + R + "-\r\\' disabled='disabled'><option selected=''></option></select>",
                e.querySelectorAll("[selected]").length || H.push("\\[" + Ae + "*(?:value|" + X + ")"),
                ...
                t.setAttribute("name", ""),
                e.appendChild(t),
                e.querySelectorAll("[name='']").length || H.push("\\[" + Ae + "*name" + Ae + "*=" + Ae + "*(?:''|\"\")")
            }),
            ...
            _ = function(e, t) {
                ...
                1 & r || !ye.sortDetached && t.compareDocumentPosition(e) === r ? e === N || e.ownerDocument == qe && n.contains(qe, e) ? -1 : t === N || t.ownerDocument == qe && n.contains(qe, t) ? 1 : A ? fe.call(A, e) - fe.call(A, t) : 0 : 4 & r ? -1 : 1)
            }
            ,
            N) : N
        }
        ...
        function h(e, t) {
            ...
            u = [],
            l = k.preFilter; s; ) {
                r && !(i = Y.exec(s)) || (i && (s = s.slice(i[0].length) || s),
                u.push(o = [])),
                r = !1,
                (i = Q.exec(s)) && (r = i.shift(),
                o.push({
                    value: r,
                    type: i[0].replace(De, " ")
                }),
                s = s.slice(r.length));
                for (a in k.filter)
                    !(i = ee[a].exec(s)) || l[a] && !(i = l[a](i)) || (r = i.shift(),
                    o.push({
                        value: r,
                        type: a,
                        matches: i
        ...
        function b(e, t, n, r, o, a) {
            ...
            o && !o[R] && (o = b(o, a)),
            i(function(i, a, s, u) {
                var l, c, f, p, d = [], h = [], g = a.length, v = i || m(t || "*", s.nodeType ? [s] : s, []), y = !e || !i && t ? v : x(v, d, e, s, u);
                if (n ? (p = o || (i ? e : g || r) ? [] : a,
                n(y, p, s, u)) : p = y,
                r)
                    for (l = x(p, h),
                ...
                if (i) {
                    if (o || e) {
                        ...
                        for (c = p.length; c--; )
                            (f = p[c]) && (l = o ? fe.call(i, f) : d[c]) > -1 && (i[l] = !(a[l] = f))
                    }
                } else
                    p = x(p === a ? p.splice(g, p.length) : p),
                    o ? o(null, a, p, u) : P.apply(a, p)
            })
        }
        function w(e) {
        ...
        function T(e, t) {
            var n = t.length > 0
              ...
              , o = function(i, o, a, s, u) {
                var l, c, f, d = 0, h = "0", g = i && [], v = [], y = j, m = i || r && k.find.TAG("*", u), b = M += null == y ? 1 : Math.random() || .1, w = m.length;
                for (u && (j = o == N || o || u); h !== w && null != (l = m[h]); h++) {
                    if (r && l) {
                        for (c = 0,
                        o || l.ownerDocument == N || (p(l),
                        a = !L); f = e[c++]; )
                            if (f(l, o || N, a)) {
                                P.call(s, l);
                                break
        ...
        function S(e, t, n, r) {
            ...
            1 === c.length) {
                ...
                o.length > 2 && "ID" === (a = o[0]).type && 9 === t.nodeType && L && k.relative[o[1].type]) {
                    if (t = (k.find.ID(a.matches[0].replace(oe, se), t) || [])[0],
                    !t)
                        return n;
                    l && (t = t.parentNode),
                    e = e.slice(o.shift().value.length)
                }
                for (i = ee.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i],
                !k.relative[s = a.type]); )
            ...
            return (l || C(e, c))(r, t, !L, n, !t || ie.test(e) && f(t.parentNode) || t),
            n
        }
        var E, k, j, A, D, N, q, L, H, O, P = Le, R = Se.expando, M = 0, I = 0, W = r(), F = r(), $ = r(), B = r(), _ = function(e, t) {
            return e === t && (D = !0),
            0
        }, X = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", U = "(?:\\\\[\\da-fA-F]{1,6}" + Ae + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", z = "\\[" + Ae + "*(" + U + ")(?:" + Ae + "*([*^$|!~]?=)" + Ae + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + U + "))|)" + Ae + "*\\]", V = ":(" + U + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + z + ")*)|.*)\\)|)", G = new RegExp(Ae + "+","g"), Y = new RegExp("^" + Ae + "*," + Ae + "*"), Q = new RegExp("^" + Ae + "*([>+~]|" + Ae + ")" + Ae + "*"), J = new RegExp(Ae + "|>"), K = new RegExp(V), Z = new RegExp("^" + U + "$"), ee = {
            ID: new RegExp("^#(" + U + ")"),
            CLASS: new RegExp("^\\.(" + U + ")"),
            TAG: new RegExp("^(" + U + "|[*])"),
            ATTR: new RegExp("^" + z),
        ...
        }, te = /^(?:input|select|textarea|button)$/i, ne = /^h\d$/i, re = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ie = /[+~]/, oe = new RegExp("\\\\[\\da-fA-F]{1,6}" + Ae + "?|\\\\([^\\r\\n\\f])","g"), se = function(e, t) {
        ...
        n.matchesSelector = function(e, t) {
            ...
            L && !B[t + " "] && (!H || !H.test(t)))
                try {
                    var r = O.call(e, t);
                    if (r || ye.disconnectedMatch || e.document && 11 !== e.document.nodeType)
                        return r
                } catch (i) {
                    B(t, !0)
                }
        ...
        n.contains = function(e, t) {
            return (e.ownerDocument || e) != N && p(e),
            Se.contains(e, t)
        }
        ,
        n.attr = function(e, t) {
        ...
        k = Se.expr = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return ee.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && K.test(n) && (t = h(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                ATTR: function(e, t, r) {
                    return function(i) {
                        var o = n.attr(i, e);
                        return null == o ? "!=" === t : !t || (o += "",
                        "=" === t ? o === r : "!=" === t ? o !== r : "^=" === t ? r && 0 === o.indexOf(r) : "*=" === t ? r && o.indexOf(r) > -1 : "$=" === t ? r && o.slice(-r.length) === r : "~=" === t ? (" " + o.replace(G, " ") + " ").indexOf(r) > -1 : "|=" === t && (o === r || o.slice(0, r.length + 1) === r + "-"))
                    }
                },
                CHILD: function(e, t, n, r, i) {
                    ...
                    : function(t, n, l) {
                        var c, f, p, d, h, g = a !== s ? "nextSibling" : "previousSibling", v = t.parentNode, y = u && t.nodeName.toLowerCase(), m = !l && !u, x = !1;
                        if (v) {
                            if (a) {
                                for (; g; ) {
                                    for (p = t; p = p[g]; )
                                        if (u ? o(p, y) : 1 === p.nodeType)
                                            return !1;
                            ...
                            x = d),
                            x === !1)
                                for (; (p = ++d && p && p[g] || (x = d = 0) || h.pop()) && ((u ? !o(p, y) : 1 !== p.nodeType) || !++x || (m && (f = p[R] || (p[R] = {}),
                                f[e] = [M, x]),
                                p !== t)); )
                                    ;
                            return x -= i,
                ...
                PSEUDO: function(e, t) {
                    ...
                    return o[R] ? o(t) : o.length > 1 ? (r = [e, e, "", t],
            ...
            pseudos: {
                ...
                lang: i(function(e) {
                    return Z.test(e || "") || n.error("unsupported lang: " + e),
        ...
        k.setFilters = new d,
        ye.sortStable = R.split("").sort(_).join("") === R,
        p(),
    ...
    var Me, Ie = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, We = Se.fn.init = function(e, t, n) {
        var r, i;
        if (!e)
            return this;
        if (n = n || Me,
        "string" == typeof e) {
            if (r = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : Ie.exec(e),
            !r || !r[1] && t)
                return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);
            if (r[1]) {
                if (t = t instanceof Se ? t[0] : t,
                Se.merge(this, Se.parseHTML(r[1], t && t.nodeType ? t.ownerDocument || t : be, !0)),
                Re.test(r[1]) && Se.isPlainObject(t))
                    for (r in t)
                        me(this[r]) ? this[r](t[r]) : this.attr(r, t[r]);
                return this
            }
            return i = be.getElementById(r[2]),
            i && (this[0] = i,
            this.length = 1),
            this
        }
        ...
        this.length = 1,
        this) : me(e) ? void 0 !== n.ready ? n.ready(e) : e(Se) : Se.makeArray(e, this)
    }
    ;
    We.prototype = Se.fn,
    Me = Se(be);
    ...
    Se.each({
        ...
        contents: function(e) {
            return null != e.contentDocument && se(e.contentDocument) ? e.contentDocument : (o(e, "template") && (e = e.content || e),
        ...
        Se.fn[e] = function(n, r) {
            ...
            this.length > 1 && ($e[e] || Se.uniqueSort(i),
            Fe.test(e) && i.reverse()),
            this.pushStack(i)
        }
    });
                ...
                then: function(t, r, i) {
                    function o(t, n, r, i) {
                        return function() {
                            var s = this
                              ...
                              , l = function() {
                                ...
                                if (!(t < a)) {
                                    ...
                                    me(l) ? i ? l.call(e, o(a, n, c, i), o(a, n, f, i)) : (a++,
                                    l.call(e, o(a, n, c, i), o(a, n, f, i), o(a, n, c, n.notifyWith))) : (r !== c && (s = void 0,
                                    u = [e]),
                                    (i || n.resolveWith)(s, u))
                                }
                            }
                              , p = i ? l : function() {
                                try {
                                    ...
                                    Se.Deferred.exceptionHook && Se.Deferred.exceptionHook(e, p.error),
                                    t + 1 >= a && (r !== f && (s = void 0,
                                    u = [e]),
                                    n.rejectWith(s, u))
                                }
                            ...
                            ;
                            t ? p() : (Se.Deferred.getErrorHook ? p.error = Se.Deferred.getErrorHook() : Se.Deferred.getStackHook && (p.error = Se.Deferred.getStackHook()),
                            e.setTimeout(p))
                        }
                    }
                    var a = 0;
    ...
    Se.extend({
        ...
        ready: function(e) {
            ...
            e !== !0 && --Se.readyWait > 0 || Xe.resolveWith(be, [Se]))
        }
    }),
    Se.ready.then = Xe.then,
    "complete" === be.readyState || "loading" !== be.readyState && !be.documentElement.doScroll ? e.setTimeout(Se.ready) : (be.addEventListener("DOMContentLoaded", d),
    ...
    v.prototype = {
        cache: function(e) {
            ...
            return t || (t = {},
            Ge(e) && (e.nodeType ? e[this.expando] = t : Object.defineProperty(e, this.expando, {
                value: t,
                configurable: !0
            }))),
            t
        ...
        remove: function(e, t) {
            ...
            if (void 0 !== r) {
                if (void 0 !== t) {
                    Array.isArray(t) ? t = t.map(g) : (t = g(t),
        ...
        data: function(e, t) {
            ...
            if (void 0 === e) {
                ...
                1 === o.nodeType && !Ye.get(o, "hasDataAttrs"))) {
                    for (n = a.length; n--; )
                        a[n] && (r = a[n].name,
                        0 === r.indexOf("data-") && (r = g(r.slice(5)),
                        m(o, r, i[r])));
    ...
    Se.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                r = Ye.get(e, t),
                n && (!r || Array.isArray(n) ? r = Ye.access(e, t, Se.makeArray(n)) : r.push(n)),
                r || []
        },
    ...
    var ot = function(e, t) {
        return e = t || e,
        "none" === e.style.display || "" === e.style.display && rt(e) && "none" === Se.css(e, "display")
    }
      , at = {};
    Se.fn.extend({
        show: function() {
    ...
    ct.th = ct.td,
    ye.option || (ct.optgroup = ct.option = [1, "<select multiple='multiple'>", "</select>"]);
    var ft = /<|&#?\w+;/
      , pt = /^([^.]*)(?:\.(.+)|)/;
    Se.event = {
        global: {},
            ...
            if (v && (u = v.events)) {
                ...
                l = t.length; l--; )
                    ...
                    d) {
                        ...
                        a && !p.length && (f.teardown && f.teardown.call(e, h, v.handle) !== !1 || Se.removeEvent(e, d, v.handle),
                        delete u[d])
                    } else
                        for (d in u)
        ...
        dispatch: function(e) {
            var t, n, r, i, o, a, s = new Array(arguments.length), u = Se.event.fix(e), l = (Ye.get(this, "events") || Object.create(null))[u.type] || [], c = Se.event.special[u.type] || {};
            for (s[0] = u,
        ...
        special: {
            ...
            click: {
                ...
                trigger: function(e) {
                    var t = this || e;
                    return st.test(t.type) && t.click && o(t, "input") && A(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    Se.each({
        ...
        Se.event.special[e] = {
            setup: function() {
                var r;
                return A(this, e, !0),
                !!be.documentMode && (r = Ye.get(this, t),
            ...
            teardown: function() {
                var e;
                return !!be.documentMode && (e = Ye.get(this, t) - 1,
                void (e ? Ye.set(this, t, e) : (this.removeEventListener(t, n),
                Ye.remove(this, t))))
            },
            _default: function(t) {
        ...
        Se.event.special[t] = {
            setup: function() {
                var r = this.ownerDocument || this.document || this
                  ...
                  , o = Ye.get(i, t);
                o || (be.documentMode ? this.addEventListener(t, n) : r.addEventListener(e, n, !0)),
                Ye.set(i, t, (o || 0) + 1)
            },
            teardown: function() {
                var r = this.ownerDocument || this.document || this
                  , i = be.documentMode ? this : r
                  , o = Ye.get(i, t) - 1;
                o ? Ye.set(i, t, o) : (be.documentMode ? this.removeEventListener(t, n) : r.removeEventListener(e, n, !0),
                Ye.remove(i, t))
            }
        }
    }),
    ...
    Se.extend({
        ...
        clone: function(e, t, n) {
            var r, i, o, a, s = e.cloneNode(!0), u = rt(e);
    ...
    Se.fn.extend({
        ...
        empty: function() {
            for (var e, t = 0; null != (e = this[t]); t++)
                1 === e.nodeType && (Se.cleanData(T(e, !1)),
                e.textContent = "");
            return this
        },
        clone: function(e, t) {
            ...
            return Ue(this, function(e) {
                ...
                if ("string" == typeof e && !dt.test(e) && !ct[(ut.exec(e) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; n < r; n++)
                            t = this[n] || {},
                            1 === t.nodeType && (Se.cleanData(T(t, !1)),
                            t.innerHTML = e);
                        t = 0
                    } catch (i) {}
                }
        ...
        replaceWith: function() {
            ...
            return O(this, arguments, function(t) {
                ...
                Se.inArray(this, e) < 0 && (Se.cleanData(T(this)),
    ...
    !function() {
        ...
        var r, i, o, a, s, u, l = be.createElement("div"), c = be.createElement("div");
    ...
    Se.each(["height", "width"], function(e, t) {
        Se.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return !St.test(Se.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? B(e, t, r) : xt(e, Et, function() {
                        return B(e, t, r)
                    })
            },
            set: function(e, n, r) {
                var i, o = mt(e), a = !ye.scrollboxSize() && "absolute" === o.position, s = a || r, u = s && "border-box" === Se.css(e, "boxSizing", !1, o), l = r ? $(e, t, r, u, o) : 0;
                return u && a && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - $(e, t, "border", !1, o) - .5)),
                l && (i = et.exec(n)) && "px" !== (i[3] || "px") && (e.style[t] = n,
                n = Se.css(e, t)),
                F(e, n, l)
            }
        }
    }),
    Se.cssHooks.marginLeft = M(ye.reliableMarginLeft, function(e, t) {
        if (t)
            return (parseFloat(R(e, "marginLeft")) || e.getBoundingClientRect().left - xt(e, {
                marginLeft: 0
            }, function() {
    ...
    Se.fx.step = {};
    var jt, At, Dt = /^(?:toggle|show|hide)$/, Nt = /queueHooks$/;
    Se.Animation = Se.extend(Q, {
        tweeners: {
            "*": [function(e, t) {
                var n = this.createTween(e, t);
                return x(n.elem, e, et.exec(t), n),
                n
            }
            ]
        },
    ...
    Se.fn.extend({
        ...
        finish: function(e) {
            return e !== !1 && (e = e || "fx"),
            this.each(function() {
                var t, n = Ye.get(this), r = n[e + "queue"], i = n[e + "queueHooks"], o = Se.timers, a = r ? r.length : 0;
                for (n.finish = !0,
                Se.queue(this, e, []),
    ...
    Se.fn.extend({
        attr: function(e, t) {
            return Ue(this, Se.attr, e, t, arguments.length > 1)
        },
    ...
    Se.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== o && 8 !== o && 2 !== o)
                return "undefined" == typeof e.getAttribute ? Se.prop(e, t, n) : (1 === o && Se.isXMLDoc(e) || (i = Se.attrHooks[t.toLowerCase()] || (Se.expr.match.bool.test(t) ? qt : void 0)),
    ...
    Se.fn.extend({
        prop: function(e, t) {
            return Ue(this, Se.prop, e, t, arguments.length > 1)
        },
    ...
    Se.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            }) : "boolean" == typeof t && s ? t ? this.addClass(e) : this.removeClass(e) : (n = Z(e),
            this.each(function() {
                if (s)
                    for (o = Se(this),
                    i = 0; i < n.length; i++)
                    ...
                    void 0 !== e && "boolean" !== a || (r = K(this),
                    r && Ye.set(this, "__className__", r),
                    this.setAttribute && this.setAttribute("class", r || e === !1 ? "" : Ye.get(this, "__className__") || ""))
            }))
        },
        hasClass: function(e) {
            var t, n, r = 0;
    ...
    Se.extend(Se.event, {
        trigger: function(t, n, r, i) {
            var o, a, s, u, l, c, f, p, d = [r || be], h = he.call(t, "type") ? t.type : t, g = he.call(t, "namespace") ? t.namespace.split(".") : [];
            if (a = p = s = r = r || be,
            3 !== r.nodeType && 8 !== r.nodeType && !Wt.test(h + Se.event.triggered) && (h.indexOf(".") > -1 && (g = h.split("."),
            h = g.shift(),
            g.sort()),
            l = h.indexOf(":") < 0 && "on" + h,
            ...
            i || !f.trigger || f.trigger.apply(r, n) !== !1)) {
                if (!i && !f.noBubble && !xe(r)) {
                    ...
                    Wt.test(u + h) || (a = a.parentNode); a; a = a.parentNode)
                        d.push(a),
                        s = a;
                ...
                for (o = 0; (a = d[o++]) && !t.isPropagationStopped(); )
                    ...
                    c = (Ye.get(a, "events") || Object.create(null))[t.type] && Ye.get(a, "handle"),
                    c && c.apply(a, n),
                    c = l && a[l],
                    c && c.apply && Ge(a) && (t.result = c.apply(a, n),
                    t.result === !1 && t.preventDefault());
                return t.type = h,
                i || t.isDefaultPrevented() || f._default && f._default.apply(d.pop(), n) !== !1 || !Ge(r) || l && me(r[h]) && !xe(r) && (s = r[l],
                s && (r[l] = null),
                Se.event.triggered = h,
                t.isPropagationStopped() && p.addEventListener(h, Ft),
                r[h](),
                t.isPropagationStopped() && p.removeEventListener(h, Ft),
    ...
    Se.fn.extend({
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                var e = this.type;
                return this.name && !Se(this).is(":disabled") && Xt.test(this.nodeName) && !_t.test(e) && (this.checked || !st.test(e))
            }).map(function(e, t) {
                var n = Se(this).val();
    ...
    Se.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var i, o, a, s, u, l, c, f, p, d, h = Se.ajaxSetup({}, n), g = h.context || h, v = h.context && (g.nodeType || g.jquery) ? Se(g) : Se.event, y = Se.Deferred(), m = Se.Callbacks("once memory"), x = h.statusCode || {}, b = {}, w = {}, T = "canceled", C = {
                readyState: 0,
            ...
            if (y.promise(C),
            h.url = ((t || h.url || Rt.href) + "").replace(Jt, Rt.protocol + "//"),
            ...
            null == h.crossDomain) {
                ...
                try {
                    l.href = h.url,
                    l.href = l.href,
                    h.crossDomain = tn.protocol + "//" + tn.host != l.protocol + "//" + l.host
                } catch (S) {
                    h.crossDomain = !0
                }
            }
            ...
            o = h.url.replace(zt, ""),
            h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ut, "+")) : (d = h.url.slice(o.length),
            h.data && (h.processData || "string" == typeof h.data) && (o += (It.test(o) ? "&" : "?") + h.data,
            delete h.data),
            h.cache === !1 && (o = o.replace(Vt, "$1"),
            d = (It.test(o) ? "&" : "?") + "_=" + Mt.guid++ + d),
            h.url = o + d),
            ...
            C.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + en + "; q=0.01" : "") : h.accepts["*"]);
            for (p in h.headers)
    ...
    ye.cors = !!rn && "withCredentials"in rn,
    ye.ajax = rn = !!rn,
    Se.ajaxTransport(function(t) {
        var n, r;
        if (ye.cors || rn && !t.crossDomain)
            return {
                send: function(i, o) {
                    var a, s = t.xhr();
                    ...
                    n = function(e) {
                        return function() {
                            ...
                            "abort" === e ? s.abort() : "error" === e ? "number" != typeof s.status ? o(0, "error") : o(s.status, s.statusText) : o(nn[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? {
                                binary: s.response
                            } : {
                                text: s.responseText
    ...
    Se.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = on.pop() || Se.expando + "_" + Mt.guid++;
            return this[e] = !0,
            e
        }
    }),
    Se.ajaxPrefilter("json jsonp", function(t, n, r) {
        ...
        if (s || "jsonp" === t.dataTypes[0])
            ...
            s ? t[s] = t[s].replace(an, "$1" + i) : t.jsonp !== !1 && (t.url += (It.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
    ...
    Se.parseHTML = function(e, t, n) {
        ...
        t = !1);
        var r, i, o;
        return t || (ye.createHTMLDocument ? (t = be.implementation.createHTMLDocument(""),
        r = t.createElement("base"),
        r.href = be.location.href,
        t.head.appendChild(r)) : t = be),
        i = Re.exec(e),
        o = !n && [],
    ...
    Se.each(["top", "left"], function(e, t) {
        Se.cssHooks[t] = M(ye.pixelPosition, function(e, n) {
            if (n)
                return n = R(e, t),
                vt.test(n) ? Se(e).position()[t] + "px" : n
        })
    }),
    Se.each({
        Height: "height",
    ...
    return Se.noConflict = function(t) {
        return e.$ === Se && (e.$ = ln),
        t && e.jQuery === Se && (e.jQuery = un),
        Se
    }
    ,
    "undefined" == typeof t && (e.jQuery = e.$ = Se),
    Se
});
